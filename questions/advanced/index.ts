export const questions = [
  {
    ...
    goal: `An interviewer would ask such a question to engage your conceptual understanding of closures, 
    ...
    codeSample: `
// run your code from`.trim(),
    explanation: `Closure is a concept associated with functions, that allows a function to hold reference to variables in its outer scope over time.
    ...
    application: "This is where this code sample is applied",
  },
];
